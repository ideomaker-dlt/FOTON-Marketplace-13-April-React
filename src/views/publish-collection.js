...
const PublishCollection = (props) => {
  return (
    <div className="publish-collection-container">
      <Helmet>
        <title>
          Publish-Collection - FOTON - Web3's Digital Assets Hub and NFTs
        ...
        <meta
          property="og:title"
          content="Publish-Collection - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
