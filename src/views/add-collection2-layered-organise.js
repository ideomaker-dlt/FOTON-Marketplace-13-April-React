...
const AddCollection2LayeredOrganise = (props) => {
  return (
    <div className="add-collection2-layered-organise-container">
      <Helmet>
        <title>
          Add-Collection2-Layered-Organise - FOTON - Web3's Digital Assets Hub
        ...
        <meta
          property="og:title"
          content="Add-Collection2-Layered-Organise - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
