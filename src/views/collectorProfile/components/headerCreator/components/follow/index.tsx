...
export const Follow = memo(() => {
    return (
        <div className={styles.collectorProfileContainerButtons1}>
            <button type="button" className={styles.collectorProfileButton4}>
                <svg
                    viewBox="0 0 1024 1024"
                    className={`${styles.collectorProfileIcon08} fill-color-white`}
                >
                ...
                <span className={styles.collectorProfileText20}>
                    <span>Follow</span>
                    <br></br>
                </span>
            </button>
            <button type="button" className={styles.collectorProfileButton5}>
                <svg
                    viewBox="0 0 1024 1024"
                    className={`${styles.collectorProfileIcon10} fill-color-white`}
                >
                ...
                <span className={styles.collectorProfileText23}>
                    <span>Follow</span>
                    <br></br>
                </span>
            </button>
            <button type="button" className={styles.collectorProfileButton6}>
                <svg
                    viewBox="0 0 950.8571428571428 1024"
                    className={`${styles.collectorProfileIcon12} fill-color-white`}
                >
                ...
                <span className={styles.collectorProfileText26}>
                    <span>Follow</span>
                    <br></br>
                </span>
            </button>
            <button type="button" className={styles.collectorProfileButton7}>
                <span className={styles.collectorProfileText29}>
                    <span>Follow</span>
                    <br></br>
                </span>
                <svg
                    viewBox="0 0 1024 1024"
                    className={`${styles.collectorProfileIcon14} fill-color-white`}
                >
