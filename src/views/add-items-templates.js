...
const AddItemsTemplates = (props) => {
  return (
    <div className="add-items-templates-container">
      <Helmet>
        <title>
          Add-Items-Templates - FOTON - Web3's Digital Assets Hub and NFTs
        ...
        <meta
          property="og:title"
          content="Add-Items-Templates - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
