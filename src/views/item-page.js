            ...
            <div className="item-page-item-details">
              ...
              <div className="item-page-container-details">
                ...
                <div className="item-page-line-text1">
                  <span className="item-page-text005">Smart Contract</span>
                  <span className="item-page-text006">51245</span>
                </div>
                <div className="item-page-line-text2">
                  <span className="item-page-text007">Attachments</span>
                  <span className="item-page-text008">1</span>
                </div>
              ...
              <div className="item-page-container-description">
                <h2 className="item-page-text011">
            ...
            <div className="item-page-item-info-box">
              <div className="item-page-name-item">
                <div className="item-page-container01">
                  <h1 className="item-page-text012">Item name #2044</h1>
                  <div className="item-page-container02">
                    <Link to="/collection-page" className="item-page-navlink">
                      <p className="item-page-text013">
                        <span>Collection Name</span>
                        <br></br>
                      </p>
                    </Link>
                    <p className="item-page-text016">
                      <span>
                        By
                        <span
                  ...
                  <div className="item-page-container04">
                    <div className="item-page-engagement-buttons">
                      <button type="button" className="item-page-button">
                        ...
                        />
                        <span className="item-page-text022">
                          <span>2536</span>
                          <br></br>
                        </span>
                      </button>
                      <button type="button" className="item-page-button01">
                        ...
                        <span className="item-page-text025">
                          <span>2536</span>
                          <br></br>
                        </span>
                      </button>
                      <button type="button" className="item-page-button02">
                        ...
                        <span className="item-page-text028">
                          <span>2536</span>
                          <br></br>
                        </span>
                      </button>
                      <button type="button" className="item-page-button03">
                        <span className="item-page-text031">
                          <span>Avatars</span>
                          <br></br>
                        </span>
                      </button>
                    </div>
                    <h2 className="item-page-text034">
                    ...
                    <p className="item-page-text035">
                      <span>
                        Created on 23 Apr 2023 ● Owned by
                        <span
                          dangerouslySetInnerHTML={{
                            __html: ' ',
                          }}
                      ...
                      <span className="item-page-text037">John Doe</span>
                      <br></br>
                    </p>
                  </div>
                </div>
                ...
                <div className="item-page-container05">
                  <div className="item-page-buttons-buy">
                    ...
                    <button className="item-page-button04 button">
                      <span className="item-page-text039">
                        <span>Add</span>
                        <br></br>
                      </span>
                      <svg
                        viewBox="0 0 1024 1024"
                        className="item-page-icon04 fill-color-white"
                      >
                  ...
                  <button className="item-page-button05 button">
                    <span className="item-page-text042">
                      <span>
                        Make Offer
                        <span
                          dangerouslySetInnerHTML={{
                  ...
                  <div className="item-page-buttons-offers">
                    <div className="item-page-container06">
                      <button className="item-page-button06 button">
                        <span className="item-page-text045">
                          <span>
                            Offer
                            <span
                              dangerouslySetInnerHTML={{
                      ...
                      <button className="item-page-button07 button">
                        <span className="item-page-text048">
                          <span>Swap</span>
                          <br></br>
                        </span>
                        <svg
              ...
              <div className="item-page-item-details-mobile">
                <div className="item-page-tabs-row1">
                  <span className="item-page-text051">Details</span>
                  <span className="item-page-text052">Description</span>
                  <span className="item-page-text053">Creator</span>
                </div>
                <div className="item-page-container-details1">
                  <div className="item-page-line-text4">
                    <span className="item-page-text054">Token ID</span>
                    <span className="item-page-text055">512445</span>
                  </div>
                  <div className="item-page-line-text5">
                    <span className="item-page-text056">Smart Contract</span>
                    <span className="item-page-text057">51245</span>
                  </div>
                  <div className="item-page-line-text6">
                    <span className="item-page-text058">Attachments</span>
                    <span className="item-page-text059">1</span>
                  </div>
                  <div className="item-page-line-text7">
                    <span className="item-page-text060">Creator Earnings</span>
                    <span className="item-page-text061">5%</span>
                  </div>
                </div>
                <div className="item-page-container-description1">
                  <h2 className="item-page-text062">
                    The crew of pirates gathered around a campfire on a tropical
                    island, their ship anchored offshore. They toasted their
                    recent plunder and shared stories of adventure. The sound of
                    waves and the scent of saltwater filled the air, as they
              ...
              <div className="item-page-container07">
                <button type="button" className="item-page-button08">
                  <svg
                    viewBox="0 0 1024 1024"
                  ...
                  <span className="item-page-text063">
                    <span>Add to favorites</span>
                    <br></br>
                  </span>
                </button>
                <button type="button" className="item-page-button09">
                  <span className="item-page-text066">
                    <span>Follow</span>
                    <br></br>
                  </span>
                  <svg
                    viewBox="0 0 877.7142857142857 1024"
                    className="item-page-icon14 fill-color-gray"
                  >
              ...
              <div className="item-page-item-details1">
                <div className="item-page-tabs-row2">
                  <span className="item-page-text069">Traits</span>
                  <span className="item-page-text070">Rarity</span>
                </div>
                <div className="item-page-container08">
                  <div className="item-page-treat">
                    <div className="item-page-container-row">
                      <p className="item-page-text071">
                        <span>Eyes</span>
                        <br></br>
                      </p>
                      <div className="item-page-container09">
                        <p className="item-page-text074">
                          <span>243</span>
                          <br></br>
                        </p>
                        <p className="item-page-text077">
                          <span>Have it</span>
                          <br></br>
                        </p>
                      </div>
                    ...
                    <div className="item-page-container-row01">
                      <p className="item-page-text080">
                        <span>Purple</span>
                        <br></br>
                      </p>
                      <p className="item-page-text083">
                        <span>14%</span>
                        <br></br>
                      </p>
                    </div>
                  ...
                  <div className="item-page-treat1">
                    <div className="item-page-container-row02">
                      <p className="item-page-text086">
                        <span>Eyes</span>
                        <br></br>
                      </p>
                      <div className="item-page-container10">
                        <p className="item-page-text089">
                          <span>243</span>
                          <br></br>
                        </p>
                        <p className="item-page-text092">
                          <span>Have it</span>
                          <br></br>
                        </p>
                      </div>
                    ...
                    <div className="item-page-container-row03">
                      <p className="item-page-text095">
                        <span>Purple</span>
                        <br></br>
                      </p>
                      <p className="item-page-text098">
                        <span>14%</span>
                        <br></br>
                      </p>
                    </div>
                  ...
                  <div className="item-page-treat2">
                    <div className="item-page-container-row04">
                      <p className="item-page-text101">
                        <span>Eyes</span>
                        <br></br>
                      </p>
                      <div className="item-page-container11">
                        <p className="item-page-text104">
                          <span>243</span>
                          <br></br>
                        </p>
                        <p className="item-page-text107">
                          <span>Have it</span>
                          <br></br>
                        </p>
                      </div>
                    ...
                    <div className="item-page-container-row05">
                      <p className="item-page-text110">
                        <span>Purple</span>
                        <br></br>
                      </p>
                      <p className="item-page-text113">
                        <span>14%</span>
                        <br></br>
                      </p>
                    </div>
                  ...
                  <div className="item-page-treat3">
                    <div className="item-page-container-row06">
                      <p className="item-page-text116">
                        <span>Eyes</span>
                        <br></br>
                      </p>
                      <div className="item-page-container12">
                        <p className="item-page-text119">
                          <span>243</span>
                          <br></br>
                        </p>
                        <p className="item-page-text122">
                          <span>Have it</span>
                          <br></br>
                        </p>
                      </div>
                    ...
                    <div className="item-page-container-row07">
                      <p className="item-page-text125">
                        <span>Purple</span>
                        <br></br>
                      </p>
                      <p className="item-page-text128">
                        <span>14%</span>
                        <br></br>
                      </p>
                    </div>
                  ...
                  <div className="item-page-treat4">
                    <div className="item-page-container-row08">
                      <p className="item-page-text131">
                        <span>Eyes</span>
                        <br></br>
                      </p>
                      <div className="item-page-container13">
                        <p className="item-page-text134">
                          <span>243</span>
                          <br></br>
                        </p>
                        <p className="item-page-text137">
                          <span>Have it</span>
                          <br></br>
                        </p>
                      </div>
                    ...
                    <div className="item-page-container-row09">
                      <p className="item-page-text140">
                        <span>Purple</span>
                        <br></br>
                      </p>
                      <p className="item-page-text143">
                        <span>14%</span>
                        <br></br>
                      </p>
                    </div>
                  ...
                  <div className="item-page-treat5">
                    <div className="item-page-container-row10">
                      <p className="item-page-text146">
                        <span>Eyes</span>
                        <br></br>
                      </p>
                      <div className="item-page-container14">
                        <p className="item-page-text149">
                          <span>243</span>
                          <br></br>
                        </p>
                        <p className="item-page-text152">
                          <span>Have it</span>
                          <br></br>
                        </p>
                      </div>
                    ...
                    <div className="item-page-container-row11">
                      <p className="item-page-text155">
                        <span>Purple</span>
                        <br></br>
                      </p>
                      <p className="item-page-text158">
                        <span>14%</span>
                        <br></br>
                      </p>
                    </div>
                  ...
                  <div className="item-page-treat6">
                    <div className="item-page-container-row12">
                      <p className="item-page-text161">
                        <span>Eyes</span>
                        <br></br>
                      </p>
                      <div className="item-page-container15">
                        <p className="item-page-text164">
                          <span>243</span>
                          <br></br>
                        </p>
                        <p className="item-page-text167">
                          <span>Have it</span>
                          <br></br>
                        </p>
                      </div>
                    ...
                    <div className="item-page-container-row13">
                      <p className="item-page-text170">
                        <span>Purple</span>
                        <br></br>
                      </p>
                      <p className="item-page-text173">
                        <span>14%</span>
                        <br></br>
                      </p>
                    </div>
                  ...
                  <div className="item-page-treat7">
                    <div className="item-page-container-row14">
                      <p className="item-page-text176">
                        <span>Eyes</span>
                        <br></br>
                      </p>
                      <div className="item-page-container16">
                        <p className="item-page-text179">
                          <span>243</span>
                          <br></br>
                        </p>
                        <p className="item-page-text182">
                          <span>Have it</span>
                          <br></br>
                        </p>
                      </div>
                    ...
                    <div className="item-page-container-row15">
                      <p className="item-page-text185">
                        <span>Purple</span>
                        <br></br>
                      </p>
                      <p className="item-page-text188">
                        <span>14%</span>
                        <br></br>
                      </p>
                    </div>
              ...
              <div className="item-page-item-details2">
                <div className="item-page-tabs-row3">
                  <span className="item-page-text191">Offers</span>
                  <span className="item-page-text192">Listings</span>
                  <span className="item-page-text193">Activity</span>
                </div>
                    ...
                    <div className="item-page-second-column header-second-column">
                      <div className="item-page-group1">
                        <div className="item-page-name">
                          <span className="item-page-text194">
                            <span className="Content16SemiBold item-page-text195">
                              Price
                            </span>
                            <br></br>
                          </span>
                      ...
                      <div className="item-page-group2">
                        <div className="item-page-change">
                          <span className="item-page-text198 Content16SemiBold">
                            expiration
                          </span>
                        </div>
                    ...
                    <div className="item-page-second-column1 table-row-second-column">
                      <div className="item-page-group11">
                        ...
                        <div className="item-page-volume1">
                          <span className="item-page-text203 Content16SemiBold">
                            59% below
                          </span>
                        </div>
                      </div>
                      <div className="item-page-group21">
                        <div className="item-page-change02">
                          <span className="item-page-text204">in 21 hours</span>
                        </div>
                        ...
                        <div className="item-page-change03">
                          <span className="item-page-text206">rdx7..274g</span>
                    ...
                    <div className="item-page-second-column2 table-row-second-column">
                      <div className="item-page-group12">
                        ...
                        <div className="item-page-volume2">
                          <span className="item-page-text208 Content16SemiBold">
                            59% below
                          </span>
                        </div>
                      </div>
                      <div className="item-page-group22">
                        <div className="item-page-change04">
                          <span className="item-page-text209">in 21 hours</span>
                        </div>
                        <div className="item-page-floor2">
                          <span className="item-page-text-mobile1 Content16SemiBold">
                            Floor:
                          </span>
                          <span className="item-page-text210 Content16SemiBold">
                            1
                          </span>
                        </div>
                        <div className="item-page-change05">
                          <span className="item-page-text211">rdx7..274g</span>
                    ...
                    <div className="item-page-second-column3 table-row-second-column">
                      <div className="item-page-group13">
                        <div className="item-page-name3">
                          <span className="item-page-text212 Content16SemiBold">
                            357 XRD
                          </span>
                        </div>
                        <div className="item-page-volume3">
                          <span className="item-page-text213 Content16SemiBold">
                            59% below
                          </span>
                        </div>
                      </div>
                      <div className="item-page-group23">
                        <div className="item-page-change06">
                          <span className="item-page-text214">in 21 hours</span>
                        </div>
                        <div className="item-page-floor3">
                          <span className="item-page-text-mobile2 Content16SemiBold">
                            Floor:
                          </span>
                          <span className="item-page-text215 Content16SemiBold">
                            1
                          </span>
                        </div>
                        <div className="item-page-change07">
                          <span className="item-page-text216">rdx7..274g</span>
                    ...
                    <div className="item-page-second-column4 table-row-second-column">
                      ...
                      <div className="item-page-group24">
                        <div className="item-page-change08">
                          <span className="item-page-text219">in 21 hours</span>
                        </div>
                        ...
                        <div className="item-page-change09">
                          <span className="item-page-text221">rdx7..274g</span>
                    ...
                    <div className="item-page-second-column5 table-row-second-column">
                      <div className="item-page-group15">
                        ...
                        <div className="item-page-volume5">
                          <span className="item-page-text223 Content16SemiBold">
                            59% below
                          </span>
                        </div>
                      </div>
                      <div className="item-page-group25">
                        <div className="item-page-change10">
                          <span className="item-page-text224">in 21 hours</span>
                        </div>
                        <div className="item-page-floor5">
                          <span className="item-page-text-mobile4 Content16SemiBold">
                            Floor:
                          </span>
                          <span className="item-page-text225 Content16SemiBold">
                            1
                          </span>
                        </div>
                        <div className="item-page-change11">
                          <span className="item-page-text226">rdx7..274g</span>
                    ...
                    <div className="item-page-second-column6 table-row-second-column">
                      <div className="item-page-group16">
                        ...
                        <div className="item-page-volume6">
                          <span className="item-page-text228 Content16SemiBold">
                            59% below
                          </span>
                        </div>
                      </div>
                      <div className="item-page-group26">
                        <div className="item-page-change12">
                          <span className="item-page-text229">in 21 hours</span>
                        </div>
                        <div className="item-page-floor6">
                          <span className="item-page-text-mobile5 Content16SemiBold">
                            Floor:
                          </span>
                          <span className="item-page-text230 Content16SemiBold">
                            1
                          </span>
                        </div>
                        <div className="item-page-change13">
                          <span className="item-page-text231">rdx7..274g</span>
                    ...
                    <div className="item-page-second-column7 header-second-column">
                      <div className="item-page-group17">
                        <div className="item-page-name7">
                          <span className="item-page-text232">
                            <span className="Content16SemiBold item-page-text233">
                              Type
                            </span>
                            <br></br>
                          </span>
                        ...
                        <div className="item-page-volume7">
                          <span className="item-page-text235 Content16SemiBold">
                            Price
                          </span>
                        </div>
                      </div>
                      <div className="item-page-group27">
                        ...
                        <div className="item-page-floor7">
                          ...
                          <span className="item-page-text238 Content16SemiBold">
                            To
                          </span>
                        </div>
                    ...
                    <div className="item-page-second-column8 table-row-second-column">
                      <div className="item-page-group18">
                        <div className="item-page-name8">
                          <span className="item-page-text240 Content16SemiBold">
                            Transfer
                          </span>
                        </div>
                      ...
                      <div className="item-page-group28">
                        <div className="item-page-change16">
                          <span className="item-page-text242">John Woo</span>
                        </div>
                        <div className="item-page-floor8">
                          <span className="item-page-text-mobile6 Content16SemiBold">
                            From
                          </span>
                          <span className="item-page-text243 Content16SemiBold">
                            Mike Sena
                          </span>
                        ...
                        <div className="item-page-change17">
                          <span className="item-page-text245">
                            21 Apr. 2023
                          </span>
