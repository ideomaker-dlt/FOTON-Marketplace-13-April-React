...
const CreatorStudioCollection = (props) => {
  return (
    <div className="creator-studio-collection-container">
      <Helmet>
        <title>
          Creator-Studio-Collection - FOTON - Web3's Digital Assets Hub and NFTs
        ...
        <meta
          property="og:title"
          content="Creator-Studio-Collection - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
