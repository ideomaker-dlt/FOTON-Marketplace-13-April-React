...
const CollectorHub = (props) => {
  return (
    <div className="collector-hub-container">
      <Helmet>
        <title>
          Collector-Hub - FOTON - Web3's Digital Assets Hub and NFTs Marketplace
          on Radix DLT
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Collector-Hub - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
