    ...
    <div className='home-container'>
      ...
      <LayoutWithSidebar>
        ...
        <div className='home-collections'>
          <TrendingCarousel rootClassName='trending-carousel1-root-class-name' />
          <TrendingCarousel rootClassName='trending-carousel1-root-class-name2' />
          <TrendingCarousel rootClassName='trending-carousel1-root-class-name1' />
        </div>
      </LayoutWithSidebar>
    </div>
  )
