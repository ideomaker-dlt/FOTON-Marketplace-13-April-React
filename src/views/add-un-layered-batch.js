...
const AddUnLayeredBatch = (props) => {
  return (
    <div className="add-un-layered-batch-container">
      <Helmet>
        <title>
          Add-Un-Layered-Batch - FOTON - Web3's Digital Assets Hub and NFTs
        ...
        <meta
          property="og:title"
          content="Add-Un-Layered-Batch - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
