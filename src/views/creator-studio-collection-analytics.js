...
const CreatorStudioCollectionAnalytics = (props) => {
  return (
    <div className="creator-studio-collection-analytics-container">
      <Helmet>
        <title>
          Creator-Studio-Collection-Analytics - FOTON - Web3's Digital Assets
        ...
        <meta
          property="og:title"
          content="Creator-Studio-Collection-Analytics - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
