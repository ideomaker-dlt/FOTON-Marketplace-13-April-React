...
const AddCollection2LayeredGenerate = (props) => {
  return (
    <div className="add-collection2-layered-generate-container">
      <Helmet>
        <title>
          Add-Collection2-Layered-Generate - FOTON - Web3's Digital Assets Hub
        ...
        <meta
          property="og:title"
          content="Add-Collection2-Layered-Generate - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
