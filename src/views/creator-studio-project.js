...
const CreatorStudioProject = (props) => {
  return (
    <div className="creator-studio-project-container">
      <Helmet>
        <title>
          Creator-Studio-Project - FOTON - Web3's Digital Assets Hub and NFTs
        ...
        <meta
          property="og:title"
          content="Creator-Studio-Project - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
