...
const AddCollectionTemplates = (props) => {
  return (
    <div className="add-collection-templates-container">
      <Helmet>
        <title>
          Add-Collection-Templates - FOTON - Web3's Digital Assets Hub and NFTs
        ...
        <meta
          property="og:title"
          content="Add-Collection-Templates - FOTON - Web3's Digital Assets Hub and NFTs Marketplace on Radix DLT"
        />
        <meta
