  ...
  return (
    <div className={`ranking-list-ranking-list ${props.rootClassName} `}>
      <div className="ranking-list-categories">
        <div className="ranking-list-container">
          <div className="ranking-list-timeframe">
            <button className="ranking-list-button">
              <span className="ranking-list-text">All</span>
            </button>
            <button className="ranking-list-button01">
              <span className="ranking-list-text001">Avatars</span>
            </button>
            <button className="ranking-list-button02">
              <span className="ranking-list-text002">Games</span>
            </button>
            <button className="ranking-list-button03">
              <span className="ranking-list-text003">Art</span>
            </button>
            <button className="ranking-list-button04">
              <span className="ranking-list-text004">Memberships</span>
            </button>
            <button className="ranking-list-button05">
              <span className="ranking-list-text005">Tickets</span>
            </button>
          </div>
          <div className="ranking-list-container1">
            <div
            ...
            >
              ...
              >
                <span className="ranking-list-text006">All</span>
                <div
              ...
              >
                ...
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="ranking-list-dropdown-toggle01"
                  >
                    <span className="ranking-list-text007">Avatars</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                ...
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="ranking-list-dropdown-toggle02"
                  >
                    <span className="ranking-list-text008">Art</span>
                  </div>
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="ranking-list-dropdown-toggle03"
                  >
                    <span className="ranking-list-text009">Games</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                ...
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="ranking-list-dropdown-toggle04"
                  >
                    <span className="ranking-list-text010">Memberships</span>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div className="ranking-list-container2">
          <div className="ranking-list-container3">
            <div
              data-thq="thq-dropdown"
              className="ranking-list-category1 list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="ranking-list-dropdown-toggle05"
              >
                <span className="ranking-list-text011">Category</span>
                <div
                  data-thq="thq-dropdown-arrow"
                  className="ranking-list-dropdown-arrow1"
                >
              ...
              <ul
                data-thq="thq-dropdown-list"
                className="ranking-list-dropdown-list1"
              >
                <li
                  data-thq="thq-dropdown"
                  className="ranking-list-dropdown3 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="ranking-list-dropdown-toggle06"
                  >
                    <span className="ranking-list-text012">Avatars</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                  className="ranking-list-dropdown4 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="ranking-list-dropdown-toggle07"
                  >
                    <span className="ranking-list-text013">Art</span>
                  </div>
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="ranking-list-dropdown-toggle08"
                  >
                    <span className="ranking-list-text014">Games</span>
                  </div>
                </li>
                <li
                  data-thq="thq-dropdown"
                  className="ranking-list-dropdown5 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="ranking-list-dropdown-toggle09"
                  >
                    <span className="ranking-list-text015">Memberships</span>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="ranking-list-filter-buttons">
            <div className="ranking-list-timeframe1">
              <button className="ranking-list-button06">
                <span className="ranking-list-text016">1h</span>
              </button>
              <button className="ranking-list-button07">
                <span className="ranking-list-text017">6h</span>
              </button>
              <button className="ranking-list-button08">
                <span className="ranking-list-text018">24h</span>
              </button>
              <button className="ranking-list-button09">
                <span className="ranking-list-text019">1d</span>
              </button>
              <button className="ranking-list-button10">
                <span className="ranking-list-text020">7d</span>
              </button>
              <button className="ranking-list-button11">
                <span className="ranking-list-text021">All</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="ranking-list-top-collections">
        <div className="ranking-list-header-table">
          <div className="header-first-column">
            <span className="ranking-list-text022 Content16SemiBold">#</span>
          </div>
          <div className="header-second-column">
            ...
            <div className="ranking-list-group2">
              ...
              <div className="ranking-list-floor">
                <span className="ranking-list-text026 Content16SemiBold">
                  Floor:
                </span>
            ...
            <div className="ranking-list-group-3">
              <div className="ranking-list-owners">
                <span className="ranking-list-text029">Owners</span>
              </div>
              <div className="ranking-list-listed">
                <span className="ranking-list-text030 Content16SemiBold">
                  Listed
                </span>
              </div>
              <div className="ranking-list-follow">
                <span className="ranking-list-text031 Content16SemiBold">
                  Follow
                </span>
              </div>
            </div>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text032">1</span>
          ...
          <div className="table-row-second-column">
            ...
            <div className="ranking-list-group201">
              ...
              <div className="ranking-list-floor01">
                ...
                <span className="ranking-list-text036 Content16SemiBold">
                  12645 XRD
                </span>
              </div>
              <div className="ranking-list-change03">
                <span className="ranking-list-text037">15000</span>
            ...
            <div className="ranking-list-group-301">
              ...
              <div className="ranking-list-listed01">
                <span className="ranking-list-text039 Content16SemiBold">
                  12%
                </span>
              </div>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text040">
              <span className="ranking-list-text041">2</span>
              <br className=""></br>
            </span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group102">
              ...
              <div className="ranking-list-volume02">
                <span className="ranking-list-text044 Content16SemiBold">
                  379 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group202">
              ...
              <div className="ranking-list-change05">
                <span className="ranking-list-text047">8888</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text050">3</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group103">
              ...
              <div className="ranking-list-volume03">
                <span className="ranking-list-text052 Content16SemiBold">
                  245 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group203">
              ...
              <div className="ranking-list-change07">
                <span className="ranking-list-text055">15000</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text058">4</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group104">
              ...
              <div className="ranking-list-volume04">
                <span className="ranking-list-text060 Content16SemiBold">
                  45 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group204">
              ...
              <div className="ranking-list-change09">
                <span className="ranking-list-text063">15000</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text066">5</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group105">
              ...
              <div className="ranking-list-volume05">
                <span className="ranking-list-text068 Content16SemiBold">
                  43 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group205">
              ...
              <div className="ranking-list-change11">
                <span className="ranking-list-text071">15000</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text074">100</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group106">
              ...
              <div className="ranking-list-volume06">
                <span className="ranking-list-text076 Content16SemiBold">
                  32 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group206">
              ...
              <div className="ranking-list-change13">
                <span className="ranking-list-text079">15000</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text082">100</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group107">
              ...
              <div className="ranking-list-volume07">
                <span className="ranking-list-text084 Content16SemiBold">
                  32 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group207">
              ...
              <div className="ranking-list-change15">
                <span className="ranking-list-text087">15000</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text090">100</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group108">
              ...
              <div className="ranking-list-volume08">
                <span className="ranking-list-text092 Content16SemiBold">
                  32 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group208">
              ...
              <div className="ranking-list-change17">
                <span className="ranking-list-text095">15000</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text098">100</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group109">
              ...
              <div className="ranking-list-volume09">
                <span className="ranking-list-text100 Content16SemiBold">
                  32 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group209">
              ...
              <div className="ranking-list-change19">
                <span className="ranking-list-text103">15000</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text106">100</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group110">
              ...
              <div className="ranking-list-volume10">
                <span className="ranking-list-text108 Content16SemiBold">
                  32 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group210">
              ...
              <div className="ranking-list-change21">
                <span className="ranking-list-text111">15000</span>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text114">100</span>
          ...
          <div className="table-row-second-column">
            <div className="ranking-list-group111">
              ...
              <div className="ranking-list-volume11">
                <span className="ranking-list-text116 Content16SemiBold">
                  32 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group211">
              ...
              <div className="ranking-list-change23">
                <span className="ranking-list-text119">15000</span>
            ...
            <div className="ranking-list-group-311">
              <div className="ranking-list-owners11">
                <span className="ranking-list-text120 Content16SemiBold">
                  9478
                </span>
              </div>
              <div className="ranking-list-listed11">
                <span className="ranking-list-text121 Content16SemiBold">
                  12%
                </span>
              </div>
        ...
        <div className="table-row">
          <div className="table-row-first-column">
            <span className="ranking-list-text122">100</span>
            <div className="ranking-list-image11"></div>
          </div>
          <div className="table-row-second-column">
            <div className="ranking-list-group112">
              <div className="ranking-list-name12">
                <span className="ranking-list-text123 Content16SemiBold">
                  Philosophical Pirates
                </span>
              </div>
              <div className="ranking-list-volume12">
                <span className="ranking-list-text124 Content16SemiBold">
                  32 K XRD
                </span>
              </div>
            </div>
            <div className="ranking-list-group212">
              <div className="ranking-list-change24">
                <span className="ranking-list-text125 Content16SemiBold">
                  +31%
                </span>
              </div>
              <div className="ranking-list-floor12">
                ...
                <span className="ranking-list-text126 Content16SemiBold">
                  1245 XRD
                </span>
              </div>
              <div className="ranking-list-change25">
                <span className="ranking-list-text127">15000</span>
            ...
            <div className="ranking-list-group-312">
              <div className="ranking-list-owners12">
                <span className="ranking-list-text128 Content16SemiBold">
                  9478
                </span>
              </div>
              <div className="ranking-list-listed12">
                <span className="ranking-list-text129 Content16SemiBold">
                  12%
                </span>
              </div>
              <div className="ranking-list-follow12">
                <svg viewBox="0 0 1024 1024" className="ranking-list-icon26">
                  <path
                    d="M719.147 894.549c-9.557 0-18.901-2.133-27.563-6.229-1.493-0.597-2.944-1.323-4.437-2.176l-175.232-99.968-175.232 100.011c-1.493 0.853-2.987 1.579-4.523 2.261-20.821 9.728-46.293 7.424-64.896-6.101-20.011-14.507-29.909-39.808-25.003-64.384l40.832-198.059c-15.957-14.507-41.045-37.333-68.352-62.165l-80.853-73.6c-1.152-1.067-2.347-2.261-3.328-3.499-16-16.896-21.717-41.387-14.507-63.659 7.381-22.357 26.453-38.912 49.493-43.051 1.451-0.341 2.859-0.597 4.352-0.768l200.576-22.229 83.029-183.893c0.725-1.621 1.536-3.2 2.56-4.693 11.179-20.181 32.597-32.896 55.851-32.896 23.168 0 44.544 12.715 55.851 32.853 0.896 1.536 1.749 3.115 2.56 4.779l83.115 183.979 200.576 22.229c1.451 0.128 2.901 0.384 4.437 0.725 22.997 4.267 42.069 20.736 49.408 43.179 7.253 22.229 1.493 46.848-14.507 63.744-1.024 1.109-2.176 2.304-3.328 3.328l-149.248 135.851 40.832 197.632c4.821 25.045-5.035 50.261-25.173 64.811-10.752 7.765-23.723 11.989-37.291 11.989zM371.456 614.485c-1.664 7.765-19.883 95.829-36.053 174.165l155.435-88.619c13.099-7.467 29.184-7.467 42.24 0l155.435 88.533-36.224-175.104c-3.029-14.763 1.92-30.080 13.141-40.192l132.267-120.405-177.835-19.669c-14.976-1.664-27.904-11.093-34.176-24.917l-73.728-163.029-73.643 163.029c-6.229 13.739-19.2 23.168-34.176 24.917l-177.835 19.669 132.267 120.405c11.605 10.496 16.384 26.325 12.885 41.216z"
                    className=""
                  ></path>
