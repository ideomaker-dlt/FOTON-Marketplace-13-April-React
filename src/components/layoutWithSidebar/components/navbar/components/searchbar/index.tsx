...
export const SearchBar = memo(() => {
    return (
        <div className={styles.layoutWithSidebarSearchbar}>
            <form className={styles.layoutWithSidebarForm}>
                ...
                <input
                    ...
                    name='search-field'
                    placeholder='Search...'
                    className={`${styles.layoutWithSidebarTextinput} focus-reset Content18 input`}
                />
                <div className=''>
                    <DangerousHTML
                        html={`<style>
